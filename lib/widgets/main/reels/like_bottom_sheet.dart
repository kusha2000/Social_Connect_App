...
class ReelLikesBottomSheet extends StatefulWidget {
  final String reelId;

  const ReelLikesBottomSheet({
    required this.reelId,
    Key? key,
  }) : super(key: key);

  @override
  State<ReelLikesBottomSheet> createState() => _ReelLikesBottomSheetState();
}

class _ReelLikesBottomSheetState extends State<ReelLikesBottomSheet> {
  ...
  Future<void> _loadLikes() async {
    try {
      final likes = await _reelService.getReelLikesList(widget.reelId);
      if (mounted) {
        setState(() {
          _likes = likes;
          _isLoading = false;
          ...
          Container(
            ...
            child: CircleAvatar(
              ...
              backgroundImage: NetworkImage(
                like['profileImage']?.isEmpty == true ||
                        like['profileImage'] == null
