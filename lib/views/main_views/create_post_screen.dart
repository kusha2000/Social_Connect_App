...
class _CreatePostScreenState extends State<CreatePostScreen>
  ...
  // Enhanced image picker with web support
      ...
      try {
        ...
        if (user != null) {
          ...
          if (userDetails != null) {
            ...
            bool isPostSaved = await FeedService().savePost(postDetails);
          ...
          SnackBarFunctions.showErrorSnackBar(
              context, 'Please log in to create a post');
        }
      } catch (e) {
  ...
  bool _hasImage() => _isWebPlatform ? _webImage != null : _imageFile != null;
